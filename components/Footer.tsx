      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
             ...
             <div className="space-y-2 text-sm text-gray-500 font-medium">
                <p>Sector 10, Gandhinagar<br/>Gujarat, India 382010</p>
                <p>+91 79 2322 0000</p>
          ...
          <div>
             ...
             <div className="flex space-x-4 mb-6">
                <a href="#" className="p-2 bg-gray-100 rounded-full hover:bg-black hover:text-white transition-colors"><Instagram className="w-5 h-5" /></a>
                <a href="#" className="p-2 bg-gray-100 rounded-full hover:bg-black hover:text-white transition-colors"><Facebook className="w-5 h-5" /></a>
             </div>
             <div className="bg-gray-100 p-4 rounded-lg">
                <p className="text-xs font-bold mb-2">Subscribe to our newsletter</p>
                <div className="flex gap-2">
                   <input type="email" placeholder="Email address" className="bg-white px-2 py-1 text-sm w-full outline-none border border-transparent focus:border-black" />
                   <button className="bg-black text-white px-3 py-1 text-xs font-bold uppercase">Go</button>
                </div>
             </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/admin" className="opacity-0 hover:opacity-50 transition-opacity">Staff Login</Link>
          </div>
        </div>
      </div>
    </footer>
