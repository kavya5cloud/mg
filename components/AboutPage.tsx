        ...
        <div className="grid md:grid-cols-12 gap-12 mb-24">
            ...
            <div className="md:col-span-8">
                <p className="text-xl text-gray-600 leading-relaxed mb-6">
                    Established in 2024, the Museum of Contemporary Art Gandhinagar (MOCA) stands as a testament to the evolving cultural landscape of Gujarat. Located at Veer Residency, Gandhinagar Mahudi, MOCA is not just a repository of objects, but a living, breathing space for dialogue, experimentation, and discovery.
                </p>
