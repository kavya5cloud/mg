...
import { ArrowLeft, Calendar, User, Check, QrCode, Mail, Download, Printer, Loader2 } from 'lucide-react';
...
const BookingPage: React.FC = () => {
  ...
  const handleRegistrationSubmit = (e: React.FormEvent) => {
    ...
    // Simulate Delay
    setTimeout(() => {
        setLoadingMessage('Generating Free Ticket...');
  ...
  return (
    <div className="pt-20 min-h-screen bg-gray-50 flex flex-col relative">
      ...
      <div className="flex-grow max-w-[1000px] w-full mx-auto px-6 py-12">
            ...
            <div className="mb-12 no-print">
                ...
                <div className="flex items-end justify-between mb-4">
                    ...
                    <span className="text-sm font-bold text-gray-400 uppercase tracking-widest hidden md:block">
                        Step {step === 'date' ? 1 : step === 'tickets' ? 2 : step === 'details' ? 3 : 4} of 4
                    </span>
                </div>
                {/* Progress Bar */}
        ...
        {step === 'tickets' && (
            <div className="grid md:grid-cols-2 gap-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="space-y-6">
                    <div className="bg-green-50 border border-green-200 p-4 rounded-xl text-green-800 text-sm font-bold flex items-center gap-3">
                        <Check className="w-5 h-5" />
                        Admission to MOCA is free for all visitors.
                    </div>
        ...
        {/* Step 3: Registration Form (No Payment) */}
        {step === 'details' && (
            <div className="grid md:grid-cols-2 gap-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="space-y-8">
                    <form id="payment-form" onSubmit={handleRegistrationSubmit} className="space-y-6">
                        {/* Contact Info */}
                 ...
                 {/* Summary Box */}
                <div className="bg-gray-900 text-white p-8 rounded-xl h-fit sticky top-24">
                    <h3 className="text-xl font-bold mb-6 border-b border-gray-700 pb-4">Registration Summary</h3>
        ...
        {step === 'confirmation' && (
             <div className="max-w-xl mx-auto animate-in fade-in zoom-in duration-500">
                ...
                <div className="text-center mb-8 no-print">
                    ...
                    <h2 className="text-4xl font-black mb-2 tracking-tight">You're All Set!</h2>
                    <p className="text-gray-600">
                        We have simulated sending the free ticket to <span className="font-bold text-black">{customerEmail}</span>.
                    </p>
                </div>
                ...
                <div id="printable-ticket" className="bg-white rounded-3xl overflow-hidden shadow-2xl border border-gray-200 relative transform transition-transform hover:scale-[1.01]">
                    ...
                    <div className="bg-black text-white p-6 flex justify-between items-center relative overflow-hidden">
                        ...
                        <div className="relative z-10 bg-white text-black px-3 py-1 text-xs font-bold uppercase rounded-sm">
                            Free Entry
                        </div>
                    </div>
