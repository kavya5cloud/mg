    ...
    <div className="pt-20 min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 mb-20">
        ...
        <div className="prose prose-lg text-gray-600 leading-relaxed">
            ...
            <h3 className="text-xl font-bold text-black mt-8 mb-4">2. Museum Shop</h3>
            <p>If you are not entirely satisfied with your purchase from the MOCA Design Store, we're here to help.</p>
            ...
            <p>Donations made to MOCA Gandhinagar are generally non-refundable. If you have made an error in making your donation or change your mind about contributing to MOCA, please contact us at info@mocagandhinagar.org.</p>
        </div>
      </div>
    </div>
  );
